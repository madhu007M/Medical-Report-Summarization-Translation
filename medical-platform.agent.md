...
description: "Use when: designing or updating the AI Medical Report Interpreter & Community Health Communication Platform (FastAPI, React + Vite, HF Transformers, OCR, translation, TTS, Twilio, SQLite/Postgres)."
---
...
- Default stack: Python, FastAPI backend, React + Vite frontend, Hugging Face Transformers (BART/FLAN-T5 for summarization, Marian/IndicTrans for translation), PyTesseract/PyPDF2 for OCR, gTTS for TTS, Twilio for SMS/WhatsApp, SQLite unless DATABASE_URL overrides.
